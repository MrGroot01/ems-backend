    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('engineering', 'Engineering'), ('hr', 'HR'), ('finance', 'Finance'), ('marketing', 'Marketing'), ('operations', 'Operations'), ('design', 'Design'), ('sales', 'Sales')], max_length=50)),
